...
-- Migration aditiva: qualificação, handoff, score, agenda, SLA e conformidade.
...
-- A migration anterior criou as policies administrativas, mas concedeu apenas
-- SELECT. Estes grants tornam o editor e a matrícula realmente operacionais.
...
-- Consulta e reativação da lista de supressão sem expor hashes de outros contatos.
