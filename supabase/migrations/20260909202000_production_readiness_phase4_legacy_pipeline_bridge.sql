-- Production readiness phase 4: keep old clients compatible while the canonical Kanban rolls out.
...
before insert or update of ana_stage, ana_outcome, pipeline_stage_id, stage on public.leads
