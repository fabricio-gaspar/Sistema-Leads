...
const state = {
  ...
  leads: [
    ...
    { id: 'l13', company: 'Gaspar & Cia', contact: 'Fabricio Gaspar', title: 'Diretor Comercial', phone: '(11) 99744-1875', segment: 'Tecnologia', uf: 'SP', distance: 10, score: 85, temp: 'hot', stage: 'Prospecção', value: 5000, owner: 'human', ownerName: 'Marina Vendas', staleHours: 0, escalated: false, escalationReason: '', slaInfo: 'novo lead', lastContact: 'Agora mesmo', assignedTo: null }
  ],
